...
def process_pdf_and_stream(uploaded_pdf_path: str):
    ...
    try:
        ...
        if source_file_name in existing_files:
            yield f"⚠️ {source_file_name} already ingested (text). Skipping text ingestion."
        else:
            documents = []
            ...
            if documents:
                ...
                yield "⚠️ No text extracted from PDF."
        ...
        if source_file_name in existing_imgs:
            yield f"⚠️ {source_file_name} already ingested (images). Skipping image ingestion."
        else:
            ...
            if image_info:
                ...
                yield "⚠️ No images found in PDF."
